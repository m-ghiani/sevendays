	...
	<body>
		...
		if (count($images) > 0) {
			...
			foreach (array_reverse($images) as $key => $image) {
				...
				echo "                <div itemscope itemtype=\"http://schema.org/ImageObject\" vocab=\"http://schema.org/\" typeof=\"ImageObject\" class=\"col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item\">\n";
				echo "                    <a href=\"#lb-gallery\" data-slide-to=\"{$i}\" data-toggle=\"modal\">\n";
				echo "                        <img itemprop=\"contentUrl\" property=\"contentUrl\" alt=\"\" src=\"{$thumbnail}\">\n";
